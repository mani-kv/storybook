...
import { compositionTool, storyModeTool } from '../components/preview/tools/composition';
...
import { shareTool } from '../components/preview/tools/share';
...
const defaultTools = [menuTool, compositionTool, storyModeTool, remountTool];
